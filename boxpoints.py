...
in_dir = r'C:\Users\angel\Documents\fhtw\inno\guitest_boundingbox\KiTS\KiTS-20210922T123706Z-001\KiTS'
# in_dir = r'C:\Users\angel\Documents\fhtw\inno\guitest_boundingbox\KiTS\KiTS-20210922T123706Z-002\KiTS'
...
'''for image_path in sorted(glob.glob(in_dir + "\\imagesTr")):
    case_name = re.search(r'case_[0-9]{5}.nii', image_path)
    print(case_name)
'''
...
'''for i in range(0, 5):
    ...
    scanArray_list.append(scanArray)'''

scanFilePath = all_files[0].get("vol")
print("scanfilepath: " , scanFilePath)
#scanFilePath = r"C:\Users\angel\Documents\fhtw\inno\guitest_boundingbox\KiTS\KiTS-20210922T123706Z-001\KiTS\imagesTr\case_00161.nii\imaging.nii"
...
# img= cv2.imread('plant-seedling.jpg') # reading image
...
box_data = [case, x1, y1, x2, y2]
# 1. Open a new CSV file
with open('bounding_box_points.csv', 'w') as file:
